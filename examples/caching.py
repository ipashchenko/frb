...
n_training_pulses = 25
amps = np.random.uniform(0.15, 0.25, size=n_training_pulses)
widths = np.random.uniform(0.001, 0.005, size=n_training_pulses)
dm_values = np.random.uniform(100, 500, size=n_training_pulses)
times = np.linspace(0, 20, n_training_pulses+2)[1: -1]
